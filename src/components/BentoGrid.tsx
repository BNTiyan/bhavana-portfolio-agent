...
export const BentoCard = ({ children, className, colSpan = 1, rowSpan = 1, title, icon: Icon, href, id, noFade = true }: BentoCardProps) => {
  ...
  return (
    <motion.div 
      ...
      className={cn(
        "group relative overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6 shadow-sm transition-all hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-800 flex flex-col",
        ...
        {(title || Icon) && (
          <div className="flex items-center justify-between mb-4 text-zinc-900 dark:text-zinc-100 font-semibold">
             <div className="flex items-center gap-2">
                {Icon && <div className="p-1.5 rounded-md bg-zinc-100 dark:bg-zinc-800"><Icon size={16} className="text-purple-600 dark:text-purple-400" /></div>}
