...
const Badge = ({ 
  ...
  const solidColors = {
    gradient: "bg-gradient-to-r from-purple-600 to-indigo-600 text-white border-transparent shadow-sm",
  ...
  const outlineColors = {
    gradient: "bg-transparent text-purple-600 dark:text-purple-400 border-purple-500", 
